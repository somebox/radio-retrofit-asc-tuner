 ...
 * 
 * This file is adapted from the Adafruit_TCA8418 library:
 * https://github.com/adafruit/Adafruit_TCA8418
 * 
 * Original copyright:
 * Copyright (c) 2020 Adafruit Industries
 * 
 * License: BSD (see https://github.com/adafruit/Adafruit_TCA8418/blob/main/license.txt)
 * 
 * Modifications for ESPHome: 2025
 */
#pragma once

// Default I2C address
#define TCA8418_DEFAULT_ADDR 0x34  ///< The default I2C address
...
// Interrupt status register bits (0x02)
...
// Key lock and event counter register bits (0x03)
...
// Pin IDs for matrix rows/columns (used in key events)
enum {
  TCA8418_ROW0 = 0,  // Pin ID for row 0
